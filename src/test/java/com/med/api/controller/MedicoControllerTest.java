...
class MedicoControllerTest {
    ...
    @Autowired
    private JacksonTester<DadosCadastroMedico> jsonDadosCadastro;

    @Autowired
    private JacksonTester<DadosDetalhamentoMedico> jsonDadosDetalhamento;
    ...
    void cadastrar_cenario2() throws Exception {
        ...
        var response = mockMvc.perform(
                post("/medicos").contentType(MediaType.APPLICATION_JSON).content(
                    jsonDadosCadastro.write(dadosCadastro).getJson()
                )
        ...
        var jsonResposta = jsonDadosDetalhamento.write(dadosDetalhamento).getJson();
